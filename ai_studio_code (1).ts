...
import { PredictionState, ChatMessage, MoonPhase, Bird, Activity, MatchFormat, GeoLocation } from './types';
...
const App = () => {
  ...
  const [selectedLocation, setSelectedLocation] = useState<GeoLocation>({ lat: 19.07, lng: 72.87 }); // Default Mumbai
  ...
  const handlePredict = () => {
    ...
    // Pass selectedLocation to calculation
